...
class Test(unittest.TestCase):
    def test_high_card(self):
        ...
        self.assertEqual(poker_util.high_card(hand_high_card), expect_score)

    def test_is_there_pair(self):
        self.assertFalse(poker_util.is_there_pair(hand_high_card))

        expect_score = CardValue.Four + MinComboScore.Pair
        self.assertEqual(poker_util.is_there_pair(hand_pair), expect_score)

    def test_is_there_two_pair(self):
        self.assertFalse(poker_util.is_there_two_pair(hand_high_card))
        self.assertFalse(poker_util.is_there_two_pair(hand_pair))

        expect_score = CardValue.Two + MinComboScore.Two_pairs
        self.assertEqual(poker_util.is_there_two_pair(hand_two_pairs), expect_score)
    ...
    def test_is_there_three_of_a_kind(self):
        self.assertFalse(poker_util.is_there_three_of_a_kind(hand_high_card))
        self.assertFalse(poker_util.is_there_three_of_a_kind(hand_high_card))
    ...
    def test_is_there_straight(self):
        self.assertFalse(poker_util.is_there_straight(hand_high_card))
    ...
    def test_is_there_flush(self):
        self.assertFalse(poker_util.is_there_flush(hand_high_card))
    ...
    def test_is_there_full_house(self):
        self.assertFalse(poker_util.is_there_full_house(hand_high_card))
